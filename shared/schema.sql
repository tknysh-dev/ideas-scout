...
create table criteria_verdicts (
  ...
  provider text not null,          -- довільна мітка, яку власник вписує у промт при вставці звіту ('ChatGPT', 'Gemini', 'Perplexity' тощо), плюс 'claude' для рядків синтезу — без CHECK, бо список не фіксований
  model text,
...
-- ============================================================================
-- COMPETITORS — реєстр конкурентів ніші, який пише другий виклик синтезу
-- глибокого дослідження з тих самих звітів, що власник вставив на порталі
-- (синтезовані рядки, не сирі знахідки окремих моделей; окремого етапу «конкуренти» немає).
-- ============================================================================
