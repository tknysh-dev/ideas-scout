...
if command -v shellcheck >/dev/null 2>&1; then
  # Поріг свідомо занижений до --severity=error: більшість скриптів проєкту
  # shellcheck ще НІКОЛИ не проходили, і повний прогін одразу потоне в
  # стилістичних SC2086/SC2155 та подібних. Піднімати поріг варто поступово,
  # у міру чистки конкретних файлів, а не всіх одразу.
