...
- згадуючи іншу ідею, пиши тільки її id (`PI-0006`) і не дублюй поруч назву — портал підставляє назву, статус і опис сам, у пігулці з тултіпом (правило в `shared/contracts.md`).
